...
| `printouts.spec.ts`             | `/teachers/printouts` picks 2 Nephi 2:25 and offers Beginner / Intermediate unnumbered mixed 2-column tiles plus an Advanced first-letter hint sheet (same as the app). Chunks match the app. PDFs are downloadable.                                             |

...
| `printouts.spec.ts`             | `/teachers/printouts` finder (no 100-item select): this week pins proximal Psalm 24:3–4 (honest CFM Psalms week), book radios move with arrows, search “joy” picks 2 Nephi 2:25 and updates Print tiles / hints. Sheets still cover signed-off 2 Nephi tiles + Advanced glyphs and a long verse. Proof PDFs stay on 2 Nephi 2:25. |

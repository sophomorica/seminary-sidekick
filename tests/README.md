...
| `printouts.spec.ts`             | `/teachers/printouts` picks 2 Nephi 2:25 and offers Beginner / Intermediate tiles plus an Advanced write-it-down sheet. Chunks match the app. PDFs are downloadable.                                                                                             |

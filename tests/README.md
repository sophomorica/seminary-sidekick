...
| `teachers.spec.ts`              | `/teachers` is an honest catalog: live advice + DM tips link to real posts; tools link to save-a-class / how-it-works; lesson plans and testimonials stay “coming” with no fake quotes. Homepage tease points at `/teachers`.                                    |

...
| `teachers.spec.ts`              | `/teachers` is a morning mixer (Mix / Today / This week) with real grabbers, a quiet printouts link, honest Teach beats, and no coming-soon catalog or fake quotes. New grabber routes 200. Homepage tease still points at `/teachers`.                          |

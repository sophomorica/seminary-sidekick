...
| `printouts.spec.ts`             | `/teachers/printouts` finder (no 100-item select): this week is pinned, search “joy” picks 2 Nephi 2:25 and updates Print tiles / hints. Sheets still cover signed-off 2 Nephi tiles + Advanced glyphs and a long verse. Proof PDFs stay on 2 Nephi 2:25.           |
